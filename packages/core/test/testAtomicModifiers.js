...
export default function runAtomicModifiersTests() {
  ...
  describe('test atomic modifiers', () => {
    ...
    it('should apply nested modifiers correctly', () => {
      expect(rxMd(hover(m(32)))).to.deep.equal([
